...
describe('Asset Transfer Basic Tests', () => {
    ...
    describe('Test CreateAsset', () => {
        it('should return error on CreateAsset', async () => {
            ...
            let assetTransfer = new AssetTransfer();
            try {
                await assetTransfer.CreateAsset(transactionContext, asset.ProdID, asset.Type, asset.HarvestDate, asset.Owner, asset.Grade);
        ...
        it('should return success on CreateAsset', async () => {
            ...
            let ret = JSON.parse((await chaincodeStub.getState(asset.ProdID)).toString());
    ...
    describe('Test ReadAsset', () => {
        ...
        it('should return success on ReadAsset', async () => {
            ...
            let ret = JSON.parse(await chaincodeStub.getState(asset.ProdID));
            expect(ret).to.eql(asset);
        });
    });
    ...
    describe('Test DeleteAsset', () => {
        ...
        it('should return success on DeleteAsset', async () => {
            ...
            await assetTransfer.DeleteAsset(transactionContext, asset.ProdID);
            let ret = await chaincodeStub.getState(asset.ProdID);
    ...
    describe('Test TransferAsset', () => {
        ...
        it('should return success on TransferAsset', async () => {
            ...
            await assetTransfer.TransferAsset(transactionContext, asset.ProdID, 'Me');
            let ret = JSON.parse((await chaincodeStub.getState(asset.ProdID)).toString());
    ...
    describe('Test GetAllAssets', () => {
        it('should return success on GetAllAssets', async () => {
            ...
            let expected = [
                {Record: {ProdID: 'asset1', Type: 'blue', HarvestDate: 5, Owner: 'Robert', Grade: 100}},
                {Record: {ProdID: 'asset2', Type: 'orange', HarvestDate: 10, Owner: 'Paul', Grade: 200}},
                {Record: {ProdID: 'asset3', Type: 'red', HarvestDate: 15, Owner: 'Troy', Grade: 300}},
                {Record: {ProdID: 'asset4', Type: 'pink', HarvestDate: 20, Owner: 'Van', Grade: 400}}
            ];
